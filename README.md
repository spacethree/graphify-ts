...
- first local audio/video file-node support across common media extensions, plus direct audio/video URL ingest that downloads into the same hidden-sidecar path, with graph/report categorization and watch/update coverage but no transcription yet
