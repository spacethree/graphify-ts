...
- first local audio/video file-node support across common media extensions, including hidden sidecar metadata lift, graph/report categorization, and watch/update coverage without transcription yet
